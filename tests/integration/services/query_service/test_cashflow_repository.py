...
from portfolio_common.database_models import Portfolio, Transaction, Cashflow
...
def setup_cashflow_data(db_engine, clean_db):
    ...
    with Session(db_engine) as session:
        ...
        session.add_all([
            ...
            Cashflow(transaction_id="T2", portfolio_id=portfolio_id, cashflow_date=date(2025, 1, 20), amount=Decimal("-5000"), currency="USD", classification="INVESTMENT_OUTFLOW", timing="BOD", calculation_type="NET", is_portfolio_flow=False),
            # External, should be included
