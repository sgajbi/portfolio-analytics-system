...
def setup_valuation_data(docker_services, db_engine, api_endpoints, poll_for_data):
    """
    A module-scoped fixture that cleans the DB, ingests data for a simple valuation scenario,
