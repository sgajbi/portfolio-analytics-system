...
# This fixture is defined in conftest.py or the other test file,
# but we reference it here to show its usage.
...
def docker_services(request):
    ...
    with compose:
        ...
        timeout = 180 # Increased timeout for slower CI environments
