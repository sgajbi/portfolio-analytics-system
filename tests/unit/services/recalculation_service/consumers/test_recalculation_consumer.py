# tests/unit/services/recalculation_service/app/consumers/test_recalculation_consumer.py
import pytest
...
def mock_dependencies():
    ...
    # This context manager mock is crucial for testing the transaction blocks
    @asynccontextmanager
...
async def test_consumer_marks_job_as_failed_on_logic_error(mock_dependencies):
    ...
    # It should have been called to update the status to FAILED
...
async def test_consumer_does_nothing_when_no_jobs(mock_dependencies):
    ...
    mock_repo = mock_dependencies["repo"]
    mock_logic_execute = mock_dependencies["logic_execute"]
    mock_repo.find_and_claim_job.return_value = None
    ...
    # ASSERT
    mock_repo.find_and_claim_job.assert_called_once()
