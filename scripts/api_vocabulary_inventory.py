...
def _default_server_side_controls() -> list[dict[str, Any]]:
    return [
        {
            "name": "PAS_CAP_SUPPORT_APIS_ENABLED",
            "kind": "feature_toggle",
            "default": True,
            "description": "Toggles support overview capability exposure.",
            "affects": ["pas.support.overview_api"],
            "exposure": "server_side",
            "canonicalTerm": "pas_cap_support_apis_enabled",
            "semanticId": "lotus.pas_cap_support_apis_enabled",
        },
        {
            "name": "PAS_CAP_LINEAGE_APIS_ENABLED",
            "kind": "feature_toggle",
            "default": True,
            "description": "Toggles lineage capability exposure.",
            "affects": ["pas.support.lineage_api"],
            "exposure": "server_side",
            "canonicalTerm": "pas_cap_lineage_apis_enabled",
            "semanticId": "lotus.pas_cap_lineage_apis_enabled",
        },
        {
            "name": "PAS_CAP_UPLOAD_APIS_ENABLED",
            "kind": "feature_toggle",
            "default": True,
            "description": "Toggles bulk upload capability exposure.",
            "affects": ["pas.ingestion.bulk_upload"],
            "exposure": "server_side",
            "canonicalTerm": "pas_cap_upload_apis_enabled",
            "semanticId": "lotus.pas_cap_upload_apis_enabled",
        },
        {
            "name": "PAS_CAP_SIMULATION_ENABLED",
            "kind": "feature_toggle",
            "default": True,
            "description": "Toggles simulation capability exposure.",
            "affects": ["pas.simulation.what_if"],
            "exposure": "server_side",
            "canonicalTerm": "pas_cap_simulation_enabled",
            "semanticId": "lotus.pas_cap_simulation_enabled",
        },
        {
            "name": "PAS_CAPABILITY_TENANT_OVERRIDES_JSON",
            "kind": "service_policy",
            "default": "{}",
            "description": "Tenant-level capability and workflow override policy.",
            "affects": ["/integration/capabilities"],
            "exposure": "server_side",
            "canonicalTerm": "pas_capability_tenant_overrides_json",
            "semanticId": "lotus.pas_capability_tenant_overrides_json",
        },
        {
            "name": "PAS_POLICY_VERSION",
            "kind": "service_policy",
            "default": "tenant-default-v1",
            "description": "Policy version surfaced in capabilities and policy metadata.",
            "affects": ["policyVersion", "policyProvenance.policyVersion"],
            "exposure": "server_side",
            "canonicalTerm": "pas_policy_version",
            "semanticId": "lotus.pas_policy_version",
        },
        {
            "name": "PAS_INTEGRATION_SNAPSHOT_POLICY_JSON",
            "kind": "service_policy",
            "default": "{}",
            "description": "Integration policy controlling allowed sections and strict mode.",
            "affects": ["/integration/policy/effective", "allowedSections", "warnings"],
            "exposure": "server_side",
            "canonicalTerm": "pas_integration_snapshot_policy_json",
            "semanticId": "lotus.pas_integration_snapshot_policy_json",
        },
    ]
